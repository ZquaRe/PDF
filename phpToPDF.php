<?php
require_once('pdf_api.php');

// Enter your API key below. Do not edit anything else. See phptopdf.com for details.
if(PDF_Api_Generator() == 'NO RECORD') { define("API_KEY", '');} else { define("API_KEY", PDF_Api_Generator()); }
//////////////////////////////////////////////////////////////////////////////////
...
{
    echo '<small>HATA: PDF SISTEMİNDE SORUN VAR! LÜTFEN DAHA SONRA TEKRAR DENEYİNİZ.</small>';
}
else
{
